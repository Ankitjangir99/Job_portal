            ...
            <div class='block-archive-inner jobs-head-details'>
              <div class='civi-jobs-header-top'>
                <div className='card job-grid-box'>
                  ...
                  <div class='block-archive-inner jobs-insights-details active on px-4'>
                      ...
                      <div class='row'>
                        <li class='list-item col-md-4 col-sm-6'>
                          ...
                          <div class='info'>
                            ...
                            <p class='details-info'>October 27, 2022</p>
                          </div>
                        </li>
                        <li class='list-item col-md-4 col-sm-6'>
                          <div class='icon-jobs'>
                          ...
                          <div class='info'>
                            ...
                            <p class='details-info'>July 22, 2025</p>
                          </div>
                        </li>
                        <li class='list-item col-md-4 col-sm-6'>
                          <div class='icon-jobs'>
                        ...
                        <li class='list-item col-md-4 col-sm-6'>
                          <div class='icon-jobs'>
                            ...
                            >
                              <path
                                d='M20 2V16.721C20.0001 16.818 19.972 16.913 19.9191 16.9943C19.8662 17.0756 19.7908 17.1398 19.702 17.179L11 21.03L2.298 17.18C2.20894 17.1407 2.13329 17.0762 2.08035 16.9945C2.02742 16.9128 1.99949 16.8174 2 16.72V2H0V0H22V2H20ZM4 2V15.745L11 18.845L18 15.745V2H4ZM7 6H15V8H7V6ZM7 10H15V12H7V10Z'
                                fill='#da3746'
                              ></path>
                            </svg>
                          </div>
                        ...
                        <li class='list-item col-md-4 col-sm-6'>
                          ...
                          <div class='info'>
                            ...
                            <p class='details-info'>6 person</p>
                          </div>
                        </li>
                      </div>
                    </ul>
                  </div>
                  <div class='block-archive-inner jobs-description-details civi-description-details on px-4'>
                    ...
                    <div class='civi-description'>
                      ...
                      <p>
                        ...
                        companies engage with customers through mobile
                      ...
                      <ul>
                        <li>
                          Be heavily involved in turning user stories into
                          testable, maintainable and high-quality code. This is
                          a hands-on code design and coding role!
                        </li>

                        <li>
                          Be a valued member of an autonomous, cross-functional
                          team delivering our messaging experience to businesses
                          around the world
                        </li>

                        <li>
                          Promote and share knowledge for improvement of
                          methodologies and best practices
                        </li>

                        <li>
                          Close-knitted collaboration with equally passionate
                          team members having fun at work and feeling proud that
                          you are a key part of creating world-class solutions
                          for customer engagement
                        </li>
                      </ul>

                      <h4 class='wp-block-heading'>Skill &amp; Experience</h4>
                      ...
                      <ul>
                        ...
                        <li>
                          You are familiar with using Jira and Confluence in
                          your workflow
                        </li>
                      </ul>
                    </div>
